...
# Initialize Devices
needle_servo = AngularServo(NEEDLE_SERVO_PIN, min_angle=-180, max_angle=180, initial_value=None)
# pole_servo = AngularServo(POLE_SERVO_PIN, min_angle=-180, max_angle=180, initial_value=None)
