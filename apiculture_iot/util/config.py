...
DATA_COLLECTION_INTERVAL = os.environ.get('DATA_COLLECTION_INTERVAL', 60*1)
DATA_COLLECTION_SERVO_PIN = os.environ.get('DATA_COLLECTION_SERVO_PIN', 12)
DATA_COLLECTION_BME280_I2C_ADDRESS = os.environ.get('DATA_COLLECTION_BME280_I2C_ADDRESS', 0x77) # Default I2C address for BME280 (use 0x77 if needed)
